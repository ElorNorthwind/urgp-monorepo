...
import { EquityObject, EquityRgStatuses } from '@urgp/shared/entities';
...
function EquityObjectProgressCell(
  ...
  return (
    <div className="flex w-full flex-row gap-2 text-xs [&>*]:size-8 [&>*]:flex-shrink-0">
      ...
      {/* {UrgpOpinionIcon && <UrgpOpinionIcon className={cn(urgpOpinionStyle)} />} */}
      {RgResultIcon && (
        <Tooltip>
          <TooltipTrigger asChild>
...
export { EquityObjectProgressCell };
