...
const navbarItems = [
  { name: 'Учетная запись', path: '/renovation/settings' },
  { name: 'Сменить пароль', path: '/renovation/settings/change-password' },
];

const SettingsNavbar = ({ className }: { className?: string }): JSX.Element => {
