    ...
    return (
      ...
      >
        ...
        <div className="group relative -mt-2 h-10 w-full flex-grow overflow-hidden p-0 hover:overflow-visible">
          <div className="group-hover:bg-muted absolute top-0 z-50 flex h-8 w-full flex-wrap items-center justify-start gap-2 p-2  group-hover:h-max group-hover:rounded-b group-hover:border-b">
            <FacetFilter
              className="flex-grow"
