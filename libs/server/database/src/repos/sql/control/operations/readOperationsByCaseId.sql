...
LEFT JOIN renovation.users u2 ON u2.id = (o.payload->-1->>'approver')::integer
LEFT JOIN renovation.users u3 ON u3.id = (o.payload->-1->>'approveBy')::integer
LEFT JOIN renovation.users u4 ON u4.id = (o.payload->-1->>'updatedBy')::integer
WHERE case_id = ${id} 
