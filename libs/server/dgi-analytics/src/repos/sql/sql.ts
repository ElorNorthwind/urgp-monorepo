...
export const vks = {
  ...
  readUserClassificator: sql('sql/vks/readVksUserClassificator.sql'),
  ...
  readVksDailySlotStats: sql('sql/vks/readVksDailySlotStats.sql'),
  readVksUserStats: sql('sql/vks/readVksUserStats.sql'),
};
