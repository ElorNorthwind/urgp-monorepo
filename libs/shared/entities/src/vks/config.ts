...
// Письменные ответы ДГИ | Портал Мэра Москвы (mos.ru) | Портал МФЦ (md.mos.ru) | Сторонние интернет-ресурсы | Тематические группы в социальных сетях и месенжерах | Друзья и знакомые | Сотрудники "одного окна" ДГИ | Сотрудники МФЦ
export const VksDgiSurveyInfoSource = {
  'Письменные ответы ДГИ': 'Письменные ответы ДГИ',
  'Портал Мэра Москвы (mos.ru)': 'Портал Мэра Москвы (mos.ru)',
