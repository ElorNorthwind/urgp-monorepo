...
INSERT INTO control.operation_types (id, name, category, fullName, priority, needs_approval) VALUES 
(1, 'запрос', 'рассмотрение', 'Направлен запрос', 1, false),
(2, 'получено', 'рассмотрение', 'Получены документы', 1, false),
(3, 'письмо', 'рассмотрение', 'Направлено письмо', 1, false),
(4, 'звонок', 'рассмотрение', 'Устные разъяснения', 1, false),
(5, 'заявка', 'рассмотрение', 'Создана заявка', 1, false),
(6, 'проработка', 'рассмотрение', 'Иная операция', 1, false),

(7, 'отклонено (исп)', 'решение', 'По заявке не выявлено проблемы', 2, true),
(8, 'решено (исп)', 'решение', 'Описанная проблема решена', 2, true),
(9, 'нерешаемо (исп)', 'решение', 'Решить Проблему не удалось', 2, true);
