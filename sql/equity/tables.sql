...
(5, 'Запись на прием - подача документов', 3),
(6, 'Запрошено заключение - подписать акт', 4),
(7, 'Заключение УРЖП дано', 5),
(8, 'Выявлены признаки двойной продажи', 0),
(9, 'Выявлены проблемы идентификации', 0),
(10, 'Проблемы идентификации сняты', 1),
(11, 'Запрошено заключение - выдать ключи', 4),
(12, 'Запись на прием - консультация', 2),
(13, 'Консультация оказана', 3),
(14, 'Заключение УПОЖС дано', 5),
(15, 'Заключение УОРК дано', 5),
(16, 'Выданы ключи', 11),
(17, 'Примечание', 0);
