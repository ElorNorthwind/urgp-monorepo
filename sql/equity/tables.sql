...
INSERT INTO equity.object_status_types (id, name, priority) VALUES
    (6, 'Статус не определен', 0),
    (1, 'Не обращался', 1),
    (7, 'Рассмотрение документов', 2),
    (8, 'Рабочая группа', 3),
    (2, 'Акт подписан', 4),
    (3, 'Передано дольщику', 5),
    (4, 'Подрежит передаче городу', 6),
    (5, 'Передано городу', 7);
...
(1, 'Акт подписан', 'Подписан акт приема-передачи помещения', '4. выдача', 12, 21),
(16, 'Выданы ключи', 'Дольщику выданы ключи от помещения', '4. выдача', 13, 22),
